...
namespace Processor.UnitTests
{
    public class ProcessorTests
    {
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[1], 0x01);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0x00, new byte[] { 0xFF }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        public void ADC_Accumulator_Correct_When_Not_In_BDC_Mode(byte accumlatorIntialValue, byte amountToAdd, bool CarryFlagSet, byte expectedValue)
        {
            var memory =
                CarryFlagSet ?
                Memory.Memory.LoadProgram(0, new byte[] { 0x38, 0xA9, accumlatorIntialValue, 0x69, amountToAdd }, 0x00) :
                Memory.Memory.LoadProgram(0, new byte[] { 0xA9, accumlatorIntialValue, 0x69, amountToAdd }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
                                                                       ...
                                                                       bool setCarryFlag, byte expectedValue)
        {
            var memory = setCarryFlag ?
                Memory.Memory.LoadProgram(0, new byte[] { 0x38, 0xF8, 0xA9, accumlatorIntialValue, 0x69, amountToAdd }, 0x00) :
                Memory.Memory.LoadProgram(0, new byte[] { 0xF8, 0xA9, accumlatorIntialValue, 0x69, amountToAdd }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0xF8, 0xA9, accumlatorIntialValue, 0x69, amountToAdd }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0xA9, accumlatorIntialValue, 0x69, amountToAdd }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0xA9, accumlatorIntialValue, 0x29, amountToAnd }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0xA9, valueToShift, operation, expectedLocation }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0xA9, valueToShift, 0x0A }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(programCounterInitalValue, new byte[] { 0x90, offset }, programCounterInitalValue);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(programCounterInitalValue, new byte[] { 0x38, 0xB0, offset }, programCounterInitalValue);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(programCounterInitalValue, new byte[] { 0xA9, 0x00, 0xF0, offset }, programCounterInitalValue);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0x00, new byte[] { 0xA9, accumulatorValue, operation, 0x06, 0x00, 0x00, valueToTest }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(programCounterInitalValue, new byte[] { 0xA9, 0x80, 0x30, offset }, programCounterInitalValue);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(programCounterInitalValue, new byte[] { 0xA9, 0x01, 0xD0, offset }, programCounterInitalValue);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(programCounterInitalValue, new byte[] { 0xA9, 0x79, 0x10, offset }, programCounterInitalValue);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0x00 }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0xABCD, new byte[] { 0x00 }, 0xABCD);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0x58, operation, 0x00 }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0x58, 0xA9, accumulatorValue, 0x69, memoryValue, 0x00 }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(programCounterInitalValue, new byte[] { 0x50, offset }, programCounterInitalValue);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(programCounterInitalValue, new byte[] { 0xA9, 0x01, 0x69, 0x7F, 0x70, offset }, programCounterInitalValue);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0x18 }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0xF8, 0xD8 }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0x58 }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0xB8 }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0xA9, accumulatorValue, 0xC9, memoryValue }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0xA2, xValue, 0xE0, memoryValue }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0xA0, xValue, 0xC0, memoryValue }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0xC6, 0x03, 0x00, initalMemoryValue }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0xA2, initialXRegisterValue, 0xCA }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0xA0, initialYRegisterValue, 0x88 }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0xA9, accumulatorValue, 0x49, memoryValue }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0xE6, 0x03, 0x00, initalMemoryValue }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0xE6, 0x02, initalMemoryValue }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0xA2, initialXRegister, 0xE8 }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0xA0, initialYRegister, 0xC8 }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0x4C, 0x08, 0x00 }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0x6C, 0x03, 0x00, 0x08, 0x00 }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0x6C, 0xFF, 0x01, 0x08, 0x00 }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0xBBAA, new byte[] { 0x20, 0xCC, 0xCC }, 0xBBAA);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0xA9, 0x03 }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0xA9, valueToLoad }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0xA2, 0x03 }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0xA2, valueToLoad }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0xA0, 0x03 }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0xA0, valueToLoad }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        public void LSR_Negative_Set_Correctly(byte accumulatorValue, bool carryBitSet, bool expectedValue)
        {
            ...
            var memory = Memory.Memory.LoadProgram(0, new byte[] { (byte)carryOperation, 0xA9, accumulatorValue, 0x4A }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0xA9, accumulatorValue, 0x4A }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0xA9, accumulatorValue, 0x09, memoryValue }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0xA9, 0x03, 0x48 }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0x9A, 0x48 }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0x58, operation, 0x08 }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0x58, 0xA9, accumulatorValue, 0x69, memoryValue, 0x08 }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0x08 }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0xA9, 0x03, 0x48, 0xA9, 0x00, 0x68 }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0xA9, valueToLoad, 0x48, 0x68 }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            //Load Accumulator and Transfer to Stack, Clear Accumulator, and Read From stack
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0xA9, 0x01, 0x48, 0x28 }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            //Load Accumulator and Transfer to Stack, Clear Accumulator, and Read From stack
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0xA9, 0x02, 0x48, 0x28 }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            //Load Accumulator and Transfer to Stack, Clear Accumulator, and Read From stack
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0xA9, 0x08, 0x48, 0x28 }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            //Load Accumulator and Transfer to Stack, Clear Accumulator, and Read From stack
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0xA9, 0x04, 0x48, 0x28 }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            //Load Accumulator and Transfer to Stack, Clear Accumulator, and Read From stack
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0xA9, 0x40, 0x48, 0x28 }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            //Load Accumulator and Transfer to Stack, Clear Accumulator, and Read From stack
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0xA9, 0x80, 0x48, 0x28 }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0xA9, accumulatorValue, 0x2A }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        public void ROL_Zero_Set_Correctly(bool carryFlagSet, bool expectedResult)
        {
            ...
            var memory = Memory.Memory.LoadProgram(0, new byte[] { (byte)carryOperation, 0x2A }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0xA9, valueToRotate, operation, expectedLocation }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var carryOperation = carryBitSet ? 0x38 : 0x18;
            var memory = Memory.Memory.LoadProgram(0, new byte[] { (byte)carryOperation, 0xA9, accumulatorValue, 0x6A }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0xA9, accumulatorValue, 0x6A }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        public void RTI_Carry_Flag_Set_Correctly()
        {
            ...
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0xA9, 0x01, 0x48, 0x40 }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            //Load Accumulator and Transfer to Stack, Clear Accumulator, and Return from Interrupt
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0xA9, 0x02, 0x48, 0x40 }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            //Load Accumulator and Transfer to Stack, Clear Accumulator, and Return from Interrupt
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0xA9, 0x08, 0x48, 0x40 }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            //Load Accumulator and Transfer to Stack, Clear Accumulator, and Return from Interrupt
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0xA9, 0x04, 0x48, 0x40 }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            //Load Accumulator and Transfer to Stack, Clear Accumulator, and Return from Interrupt
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0xA9, 0x40, 0x48, 0x40 }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            //Load Accumulator and Transfer to Stack, Clear Accumulator, and Return from Interrupt
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0xA9, 0x80, 0x48, 0x40 }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0x00, new byte[] { 0x20, 0x04, 0x00, 0x00, 0x60 }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0xBBAA, new byte[] { 0x60 }, 0xBBAA);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        public void SBC_Accumulator_Correct_When_Not_In_BDC_Mode(byte accumlatorIntialValue, byte amountToSubtract, bool CarryFlagSet, byte expectedValue)
        {
            var memory = CarryFlagSet ?
                Memory.Memory.LoadProgram(0, new byte[] { 0x38, 0xA9, accumlatorIntialValue, 0xE9, amountToSubtract }, 0x00) :
                Memory.Memory.LoadProgram(0, new byte[] { 0xA9, accumlatorIntialValue, 0xE9, amountToSubtract }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = setCarryFlag ?
                Memory.Memory.LoadProgram(0, new byte[] { 0x38, 0xF8, 0xA9, accumlatorIntialValue, 0xE9, amountToAdd }, 0x00) :
                Memory.Memory.LoadProgram(0, new byte[] { 0xF8, 0xA9, accumlatorIntialValue, 0xE9, amountToAdd }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = setCarryFlag ?
                Memory.Memory.LoadProgram(0, new byte[] { 0x38, 0xA9, accumlatorIntialValue, 0xE9, amountToSubtact }, 0x00) :
                Memory.Memory.LoadProgram(0, new byte[] { 0xA9, accumlatorIntialValue, 0xE9, amountToSubtact }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = setCarryFlag ?
                Memory.Memory.LoadProgram(0, new byte[] { 0x38, 0xF8, 0xA9, accumlatorIntialValue, 0xE9, amountToSubtract }, 0x00) :
                Memory.Memory.LoadProgram(0, new byte[] { 0xF8, 0xA9, accumlatorIntialValue, 0xE9, amountToSubtract }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0xA9, accumlatorIntialValue, 0xE9, amountToSubtract }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0x38 }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0xF8 }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0x78 }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0xA9, 0x03, 0x85, 0x05 }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0xA2, 0x03, 0x86, 0x05 }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0xA0, 0x03, 0x84, 0x05 }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        public void Transfer_Correct_Value_Set(byte operation, RegisterMode transferFrom, RegisterMode transferTo)
        {
            ...
            var memory = Memory.Memory.LoadProgram(0, new[] { loadOperation, (byte)0x03, operation }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        public void Transfer_Negative_Value_Set(byte operation, byte value, RegisterMode transferFrom, bool expectedResult)
        {
            ...
            var memory = Memory.Memory.LoadProgram(0, new[] { loadOperation, value, operation }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0xBA }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0xA2, valueToLoad, 0x9A, 0xBA }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0xA2, 0xAA, 0x9A }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0xA9, accumulatorInitialValue, operation, valueToTest }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0xA9, accumulatorInitialValue, operation, 0x05, 0x00, valueToTest }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        public void ZeroPageX_Mode_Accumulator_Has_Correct_Result(byte operation, byte accumulatorInitialValue, byte valueToTest, byte expectedValue)
        {
            ...
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0xA9, accumulatorInitialValue, 0xA2, 0x01, operation, 0x06, 0x00, valueToTest }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0xA9, accumulatorInitialValue, operation, 0x06, 0x00, 0x00, valueToTest }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, addressWraps
        ...
        {
            var memory = Memory.Memory.LoadProgram(0,
                                  addressWraps
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { operation, 0x03, 0x00, valueToLoad }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { testXRegister ? (byte)0xA0 : (byte)0xA2, 0xFF, operation, 0x06, 0x00, valueToLoad }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { operation, 0x04, 0x00, 0x00, valueToLoad }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        public void Immediate_Mode_Compare_Operation_Has_Correct_Result(byte operation, byte accumulatorValue, byte memoryValue, RegisterMode mode)
        {
            ...
            var memory = Memory.Memory.LoadProgram(0, new[] { loadOperation, accumulatorValue, operation, memoryValue }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        public void ZeroPage_Modes_Compare_Operation_Has_Correct_Result(byte operation, byte accumulatorValue, byte memoryValue, RegisterMode mode)
        {
            ...
            var memory = Memory.Memory.LoadProgram(0, new byte[] { loadOperation, accumulatorValue, operation, 0x04, memoryValue }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        public void Absolute_Modes_Compare_Operation_Has_Correct_Result(byte operation, byte accumulatorValue, byte memoryValue, RegisterMode mode)
        {
            ...
            var memory = Memory.Memory.LoadProgram(0, new byte[] { loadOperation, accumulatorValue, operation, 0x05, 0x00, memoryValue }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { operation, 0x02, memoryValue }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { operation, 0x03, 0x00, memoryValue }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        public void ZeroPage_Mode_Memory_Has_Correct_Result(byte operation, RegisterMode mode)
        {
            ...
            var memory = Memory.Memory.LoadProgram(0, new byte[] { loadOperation, 0x04, operation, 0x00, 0x05 }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        public void Absolute_Mode_Memory_Has_Correct_Result(byte operation, byte valueToLoad, RegisterMode mode)
        {
            ...
            var memory = Memory.Memory.LoadProgram(0, new byte[] { loadOperation, valueToLoad, operation, 0x04 }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { operation, 0x00 }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, isAbsoluteX
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { 0xA0, 0x04, operation, 0x05, 0x08, 0xFF, 0xFF, 0x03 }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, isCarrySet
        ...
        public void NumberOfCyclesRemaining_Correct_When_Relative_And_Branch_On_Carry_And_Wrap(byte operation, int numberOfCyclesUsed, bool isCarrySet, bool wrapRight)
        {
            ...
            var memory = Memory.Memory.LoadProgram(initialAddress, new byte[] { (byte)carryOperation, operation, (byte)amountToMove, 0x00 }, initialAddress);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, isZeroSet
        ...
        public void NumberOfCyclesRemaining_Correct_When_Relative_And_Branch_On_Zero_And_Wrap(byte operation, int numberOfCyclesUsed, bool isZeroSet, bool wrapRight)
        {
            ...
            var memory = Memory.Memory.LoadProgram(initialAddress, new byte[] { 0xA9, (byte)newAccumulatorValue, operation, (byte)amountToMove, 0x00 }, initialAddress);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, isNegativeSet
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, isOverflowSet
        ...
        public void NumberOfCyclesRemaining_Correct_When_Relative_And_Branch_On_Overflow_And_Wrap(byte operation, int numberOfCyclesUsed, bool isOverflowSet, bool wrapRight)
        {
            ...
            var memory = Memory.Memory.LoadProgram(initialAddress, new byte[] { 0xA9, (byte)newAccumulatorValue, 0x69, 0x01, operation, (byte)amountToMove, 0x00 }, initialAddress);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, new byte[] { operation, 0x0 }, 0x00);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0, overflowSet
                ? new byte[] { 0xA9, 0x01, 0x69, 0x7F, operation, 0x00 }
                : new byte[] { 0xA9, 0x01, 0x69, 0x01, operation, 0x00 }, 0x00);
        ...
        {
            var memory = Memory.Memory.LoadProgram(0xFFFF, new byte[] { 0x38 }, 0xFFFF);
            var processor = new Processor(memory.AddressBus, memory.RwBus, memory.DataBus, memory.ReadyBus);
